...
# Default file paths used when none are passed to IsotopeDashboardGenerator
DEFAULT_PATHS = {
...
# --- Module-level Gantt CSS/JS constants ---
_GANTT_CSS = """\
        <style>
        /* Gantt Chart Styles */
        .gantt-container {
...
class IsotopeDashboardGenerator:
    ...
    # ---- Gantt conversion static helpers ----
    ...
    def _convert_isotope_to_gantt(self, data, product_code, cutoff_date_only):
        """Convert a list of bestraling records to gantt-chart dicts."""
        entries = []
        for item in data:
    ...
    @staticmethod
    def _gantt_js_html(cyclotron_json):
        """Gantt chart JavaScript block with data injected."""
        return f"""\
        <script>
...
"""
    ...
    def generate_gantt_chart_html(self, cyclotron_data):
        ...
        <div class="section" id="gantt-section">
            ...
            """
            + _GANTT_CSS
            + self._gantt_js_html(cyclotron_json)
        )
    ...
    def _fmt_date_str(date_val):
        """Format a date value as a YYYY-MM-DD string."""
        if not date_val:
            return ''
...
"""
    ...
    # ---- Dashboard color helpers as @staticmethods ----
